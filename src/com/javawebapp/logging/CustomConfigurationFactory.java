package com.javawebapp.logging;
...
public class CustomConfigurationFactory extends ConfigurationFactory
{
	...
	/*
	 * returns a configuration created by the ConfigurationBuilder. This will cause the 
	 * Configuration to automatically be hooked into Log4j when the LoggerContext
	 * is created. Any configuration files provided will be overridden
	 * 
	 * (non-Javadoc)
	 * @see org.apache.logging.log4j.core.config.ConfigurationFactory#getConfiguration(org.apache.logging.log4j.core.LoggerContext, org.apache.logging.log4j.core.config.ConfigurationSource)
	 */
	@Override
	...
	/*
	 * Because getSupportedTypes() specifies "*", it will override any config files 
	 * provided
	 * 
	 * (non-Javadoc)
