...
/**
 * This is a representation of a user's individual XRP wallet. The platform is architected 
 * such that there is one main XRP wallet for everybody and individual balances are kept in 
 * the DB since it would be too expensive to create wallets for every single user.
 * 
 * @author Evan
 *
 */
